                 ...
                 {{ csrf_field() }}
                    ...
                    <div class="card">
                       ...
                       <input type="hidden" name="id" value = "{{Auth::user()->id}}">
                                ...
                                <label class="col-md-3 col-form-label">{{ __('fullname') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input type="text" name="fullname" class="form-control" placeholder="Name" value="{{ auth()->user()->fullname }}" required>
                                    </div>
